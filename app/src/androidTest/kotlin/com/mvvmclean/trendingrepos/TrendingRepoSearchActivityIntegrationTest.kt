...
import com.mvvmclean.trendingrepos.features.trendingrepo.TrendingRepoSearchResultAdapter
import com.mvvmclean.trendingrepos.helpers.RecyclerChildView
...
internal class TrendingRepoSearchActivityIntegrationTest : BaseTest() {
    ...
    fun useAppContext() {
        ...
        assertEquals("com.mvvmclean.trendingrepos", appContext.packageName)
    }
